<?php defined('_JEXEC') or die('Direct Access to this location is not allowed.'); ?>
  <div class="jg_updexistpanel">
    <div class="jg_updexisthead"><?php echo JText::sprintf('COM_JOOMGALLERY_ADMENU_EXTENSION_NOT_UPTODATE', '<span style="font-weight:bold;">'.$this->name.'</span>'); ?></div>
...
<?php if(isset($this->extension['downloadlink'])): ?>
    <div class="jg_updexistdownload"><a href="<?php echo $this->extension['downloadlink']; ?>" target="_blank"><?php echo JText::_('COM_JOOMGALLERY_ADMENU_DOWNLOAD_UPDATE_LINK'); ?></a></div>
<?php endif;
    ...
    <div class="jg_updexistautolink">
      <a href="index.php?option=<?php echo _JOOM_OPTION; ?>&amp;task=update&amp;extension=<?php echo $this->name; ?>"><?php echo JText::_('COM_JOOMGALLERY_ADMENU_AUTOUPDATE_LINK'); ?></a></div>
<?php   endif;
        if(!$this->params->get('curl_loaded')):
    ...
    <div class="jg_updexistformsubmit">
      <a href="javascript:document.JoomUpdateForm<?php echo $this->entry; ?>.submit();"><?php echo JText::_('COM_JOOMGALLERY_ADMENU_AUTOUPDATE_LINK'); ?></a>
    </div>
<?php     endif;
          if(!$this->params->get('url_fopen_allowed')): ?>
