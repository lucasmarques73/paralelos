...
<?php   if($this->checked):
      ...
      <tr class="row<?php echo $k; ?>">
        ...
        <td align="center">
<?php       if($row->refid): ?>
          <span title="<?php echo JText::_('COM_JOOMGALLERY_MAIMAN_OF_SHOW_CATEGORY_DETAILS'); ?>" class="hasTip">
          ...
          <div class="jg_mntnoorphans">
            <p>
              <span class="jg_mntnoorphanstxt">
                <?php echo JText::_('COM_JOOMGALLERY_MAIMAN_OF_MSG_NO_ORPHANED_FOLDERS_FOUND'); ?>
              </span>
            </p>
          </div>
        </td>
