<?php
// $HeadURL: https://joomgallery.org/svn/joomgallery/JG-2.0/JG/trunk/administrator/components/com_joomgallery/models/comments.php $
...
class JoomGalleryModelComments extends JoomGalleryModel
{
  ...
  protected function _buildQuery()
  {
    ...
    $query->order($this->_db->getEscaped($this->getState('list.ordering', 'c.cmtdate')).' '.$this->_db->getEscaped($this->getState('list.direction', 'DESC')));
