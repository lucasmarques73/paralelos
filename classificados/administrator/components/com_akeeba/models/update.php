...
class AkeebaModelUpdate extends JModel
{
	...
	public function __construct( $config = array() )
	{
		...
		if(AKEEBA_PRO == 1)
		{
			$this->update_url = 'http://www.akeebabackup.com/updates/abpro.ini';
		}
		else
		{
			$this->update_url = 'http://www.akeebabackup.com/updates/abcore.ini';
		}
	}
	...
	private function getUpdateINIfopen()
	{
		...
		return @file_get_contents($this->update_url, false, $context);
	}
