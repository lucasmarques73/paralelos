 ...
 * @version $Id: statistics.php 115 2010-04-16 20:04:12Z nikosdion $
...
class AkeebaModelStatistics extends JModel
{
	...
	public function __construct()
	{
		...
		$limitstart = $mainframe->getUserStateFromRequest(JRequest::getCmd('option','com_akeeba') .'profileslimitstart','limitstart',0);
