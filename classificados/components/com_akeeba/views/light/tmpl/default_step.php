 ...
 * @version $Id: default_step.php 92 2010-03-18 10:33:11Z nikosdion $
 * @since 2.1
 */
...
<input type="hidden" name="option" value="com_akeeba" /> <input
	type="hidden" name="view" value="light" /> <input type="hidden"
	name="format" value="raw" /> <input type="hidden" name="task"
	value="step" />
<table border="0"
