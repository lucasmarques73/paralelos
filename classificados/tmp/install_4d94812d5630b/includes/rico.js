      ...
      for ( var i = 0 ; i < panels.length ; i++ ) {
         ...
         if (this.options.tabLocation != 'inline') {
            ...
            tabContentBox.style.width = (
               ...
               parseInt(RicoUtil.getElementsComputedStyle(tabContentBox, 'paddingLeft')) -
               parseInt(RicoUtil.getElementsComputedStyle(tabContentBox, 'paddingRight')) - 2) + 'px';
            ...
            tabWrapper.style.width = 
                (Math.floor(this.container.clientWidth / panels.length) - 
...
Rico.LiveGridScroller.prototype = {
   ...
   createScrollBar: function() {
      ...
      scrollerStyle.left        = this.isIE ? "-3px" : "-0px";
...
Rico.GridViewPort.prototype = {
   ...
   populateRow: function(htmlRow, row) {
      var cells = htmlRow.getElementsByTagName(this.liveGrid.options.cellTag);
      for (var j=0; j < cells.length; j++) {
   ...
   clearRows: function() {
      if (!this.isBlank) {
         ...
         var tableRows = this.table.getElementsByTagName(this.liveGrid.options.rowTag);
         for (var i=0; i < this.visibleRows; i++)
            this.populateRow(tableRows[i], this.buffer.getBlankRow());
         this.isBlank = true;
      }
   },
   ...
   refreshContents: function(startPos) {
      ...
      for (var i=0; i < blankSize; i++) {// blank out the rest 
        this.populateRow(tableRows[i + blankOffset], this.buffer.getBlankRow());
      }
...
Rico.LiveGrid.prototype = {
   ...
   initialize: function( tableId, visibleRows, totalRows, url, options, ajaxOptions ) {
     ...
     this.options = {
      ...
      var firstRow  = this.table.getElementsByTagName(this.options.rowTag)[0];
      var columnCount  = firstRow.getElementsByTagName(this.options.cellTag).length;
      this.metaData    = new Rico.LiveGridMetaData(visibleRows, totalRows, columnCount, options);
      this.buffer      = new Rico.LiveGridBuffer(this.metaData);

      var rowCount  = this.table.getElementsByTagName(this.options.rowTag).length;
...
Rico.LiveGridSort.prototype = {
   ...
   applySortBehavior: function() {
      var headerRow = this.headerTable.getElementsByTagName(this.options.rowTag)[0];
      var headerCells = headerRow.getElementsByTagName(this.options.cellTag);
