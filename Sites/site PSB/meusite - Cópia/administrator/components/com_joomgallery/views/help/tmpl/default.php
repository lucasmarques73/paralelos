...
<table cellpadding="4" cellspacing="0" border="0" width="100%" class="adminlist">
  <tr>
    <th colspan="2" align="center" bgcolor="#E7E7E7">
      <?php echo JText::_('JGA_HLPIFO_TEAM'); ?>
    </th>
  </tr>
  <tr>
    ...
    <td width="50%" align="left">
      <?php echo JText::_('JGA_HLPIFO_CHIEF').', '.JText::_('JGA_HLPIFO_PROGRAMMING'); ?>
    </td>
  </tr>
  <tr>
    <td width="50%" align="right">
    ...
    <td width="50%" align="left">
      <?php echo JText::_('JGA_HLPIFO_PROGRAMMING'); ?>
    </td>
  </tr>
<!--
  <tr>
...
<!--
  <tr>
    ...
    <td width="50%" align="left">
      <?php echo JText::_('JGA_HLPIFO_ADVISORY').', '.JText::_('JGA_HLPIFO_PROGRAMMING'); ?>
    </td>
  </tr>
-->
<!--
  <tr>
    ...
    <td width="50%" align="left">
      <?php echo JText::_('JGA_HLPIFO_QUALITY'); ?>
    </td>
  </tr>
-->
  <tr>
    ...
    <td width="50%" align="left">
      <?php echo JText::_('JGA_HLPIFO_SUPPORT').', '.JText::_('JGA_HLPIFO_QUALITY'); ?>
    </td>
  </tr>
<!--
  <tr>
...
-->
  <tr>
    ...
    <td rowspan="<?php echo count($this->languages) + 1; ?>" align="left">
      <?php echo JText::_('JGA_HLPIFO_TRANSLATION'); ?> &sup1;
    </td>
  </tr>
...
<?php   endif; ?>
        <img src="../administrator/components/<?php echo _JOOM_OPTION; ?>/assets/images/flags/<?php echo $lang['flag']; ?>"  border="0" align="top" width="16" height="11" alt="<?php echo $key; ?>" /></a>
    </td>
  </tr>
<?php endforeach; ?>
  <tr>
    <td colspan="2" align="center">
      &sup1; <?php echo JText::_('JGA_HLPIFO_DOWNLOAD_TRANSLATIONS'); ?>
    </td>
  </tr>
  <tr>
    <th colspan="2" align="center" bgcolor="#E7E7E7">
      <?php echo JText::_('JGA_HLPIFO_LINKS'); ?>
    </th>
  </tr>
  <tr>
    <td width="50%" align="right">
      <?php echo JText::_('JGA_HLPIFO_PROJECT_WEBSITE'); ?>
      <img src="../administrator/components/<?php echo _JOOM_OPTION; ?>/assets/images/flags/de.png"  border="0" align="top" width="16" height="11" alt="german" /></a>&nbsp;
    </td>
    <td width="50%" align="left">
    ...
    <td width="50%" align="right">
      <?php echo JText::_('JGA_HLPIFO_PROJECT_WEBSITE'); ?>
      <img src="../administrator/components/<?php echo _JOOM_OPTION; ?>/assets/images/flags/gb.png"  border="0" align="top" width="16" height="11" alt="english" /></a>&nbsp;
    </td>
    <td width="50%" align="left">
  ...
  <tr>
    <td width="50%" align="right">
      <?php echo JText::_('JGA_HLPIFO_SUPPORT_FORUM'); ?>
      <img src="../administrator/components/<?php echo _JOOM_OPTION; ?>/assets/images/flags/de.png"  border="0" align="top" width="16" height="11" alt="german" /></a>&nbsp;
    </td>
    <td width="50%" align="left">
  ...
  <tr>
    <td width="50%" align="right">
      <?php echo JText::_('JGA_HLPIFO_PROJECTSITE'); ?>
    </td>
    <td width="50%" align="left">
  ...
  <tr>
    <th colspan="2" align="center" bgcolor="#E7E7E7">
      <?php echo JText::_('JGA_HLPIFO_THANKS'); ?>
    </th>
  </tr>
  <tr>
    <td width="50%" align="right">
...
<!--<tr>
  ...
  <tr>
    <th colspan="2" align="center" bgcolor="#E7E7E7">
      <?php echo JText::_('JGA_HLPIFO_DONATIONS'); ?>
    </th>
  </tr>
  <tr>
    <td colspan="2" align="center">
      <?php echo JText::_('JGA_HLPIFO_DONATIONS_LONG'); ?>
  ...
  <tr>
    <td colspan="2" align="center">
      <?php echo JText::_('JGA_HLPIFO_SPONSORS'); ?>
      <a href="mailto:joom@joomgallery.net">joom@joomgallery.net</a>
    </td>
  </tr>
  <tr>
    <th colspan="2" align="center" bgcolor="#E7E7E7">
      <?php echo JText::_('JGA_HLPIFO_LICENCE'); ?>
    </th>
  </tr>
  <tr>
    <td colspan="2" align="center">
      <?php echo JText::_('JGA_HLPIFO_NO_GUARANTEE'); ?>
    </td>
  </tr>
    <th colspan="2" align="center" bgcolor="#E7E7E7">
      &nbsp;
