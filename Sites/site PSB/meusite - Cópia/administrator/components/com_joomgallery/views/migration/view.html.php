<?php
// $HeadURL: https://joomgallery.org/svn/joomgallery/JG-1.5/JG/trunk/administrator/components/com_joomgallery/views/migration/view.html.php $
...
class JoomGalleryViewMigration extends JoomGalleryView
{
  ...
  {
    JToolBarHelper::title(JText::_('JGA_MIGMAN_MIGRATION_MANAGER'));
