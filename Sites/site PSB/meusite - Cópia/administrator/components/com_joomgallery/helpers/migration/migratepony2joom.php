<?php
// $HeadURL: https://joomgallery.org/svn/joomgallery/JG-1.5/JG/trunk/administrator/components/com_joomgallery/helpers/migration/migratepony2joom.php $
// $Id: migratepony2joom.php 2566 2010-11-03 21:10:42Z mab $
/****************************************************************************************\
**   JoomGallery  1.5.6                                                                 **
 ...
 */
  function JoomMigrate_Pony2Joom($action)
  {
    ...
    if (file_exists($ponyconfig)) {
      ...
      $this->galvars['pgimgpic'] = JText::_('JGA_MIGMAN_PONYGALLERY') . JText::_('JGA_MIGMAN_IMAGES_DIRECTORY');
      $this->galvars['pgorig']   = JText::_('JGA_MIGMAN_PONYGALLERY') . JText::_('JGA_MIGMAN_ORIGINALS_DIRECTORY');
      $this->galvars['pgthumb']  = JText::_('JGA_MIGMAN_PONYGALLERY') . JText::_('JGA_MIGMAN_THUMBNAILS_DIRECTORY');
    }
  ...
  function Joom_Migrate_Check() {
    ...
    $info .= "\n";
    $info .= "    <td colspan=\"3\">\n";
    $info .= "      <h4>".JText::_('JGA_MIGMAN_SITESTATUS')."</h4>\n";
    $info .= "    </td>\n";
    $info .= "  </tr>\n";
    $info .= "  <tr>\n";
    $info .= "    <td width=\"80%\" align=\"left\">\n";
    $info .= "      ".JText::_('JGA_MIGMAN_SITE_OFFLINE')."\n";
    $info .= "    </td>\n";
    ...
    $info .= "  <tr>\n";
    $info .= "    <td colspan=\"3\">\n";
    $info .= "      <h4>".JText::_('JGA_MIGMAN_DIRECTORIES')."</h4>\n";
    $info .= "    </td>\n";
    $info .= "  </tr>\n";
    ...
    $info .= "  <tr>\n";
    $info .= "    <td colspan=\"3\">\n";
    $info .= "      <h4>".JText::_('JGA_MIGMAN_DATABASETABLES')."</h4>\n";
    $info .= "    </td>\n";
    $info .= "  </tr>\n";
    ...
    foreach ($this->joomdb as $jdb) {
      ...
      if ($ct['result'] == TRUE && $ctcount == 0 ) {
        ...
        $info .= "  <tr>\n";
        $info .= "    <td align=\"left\">\n";
        $info .= "      ".$jdb.": <b><span style=\"color:#080; font-size:12px; font-weight:bold;\">".JText::_('JGA_MIGMAN_EMPTY') . "</span></b>\n";
        $info .= "    </td>\n";
        $info .= "    <td align=\"center\">\n";
        $info .= "      <img src=\"images/$img\" border=\"0\" alt=\"\" />\n";
        $info .= "    </td>\n";
        ...
        $info .= "  <tr>\n";
        $info .= "    <td align=\"left\">\n";
        $info .= "      ".$jdb.": <b><span style=\"color:#f30; font-weight:bold;\">".$ctcount ." ".JText::_('JGA_MIGMAN_ROWS') . "</span></b>\n";
        $info .= "    </td>\n";
        $info .= "    <td align=\"center\">\n";
        $info .= "      &nbsp;\n";
        $info .= "    </td>\n";
    ...
    foreach ($this->ponydb as $pdb) {
      ...
      if ($ct['result'] == TRUE) {
        ...
        if ($ct['result'] == TRUE && $count == 0 ) {
          ...
          $info .= "  <tr>\n";
          $info .= "    <td align=\"left\">\n";
          $info .= "      ".$pdb.": <b><span style=\"color:#080; font-size:12px; font-weight:bold;\">".JText::_('JGA_MIGMAN_EMPTY') . "</span></b>\n";
          $info .= "    </td>\n";
          $info .= "    <td align=\"center\">\n";
          $info .= "      <img src=\"images/$img\" border=\"0\" alt=\"\" />\n";
          $info .= "    </td>\n";
          ...
          $info .= "  <tr>\n";
          $info .= "    <td align=\"left\">\n";
          $info .= "      ".$pdb.": <b><span style=\"color:#080; font-weight:bold;\">".$count ." ".JText::_('JGA_MIGMAN_ROWS') . "</span></b>\n";
          $info .= "    </td>\n";
          $info .= "    <td align=\"center\">\n";
          $info .= "      <img src=\"images/$img\" border=\"0\" alt=\"\" />\n";
          $info .= "    </td>\n";
    ...
    if ($resultarr['result'] != FALSE) {
      ...
      if ($ctcount == 0 ) {
        ...
        $info .= "  <tr>\n";
        $info .= "    <td align=\"left\">\n";
        $info .= "      ".JText::_('JGA_MIGMAN_ORPHANPICS')." <b><span style=\"color:#080; font-size:12px; font-weight:bold;\">".JText::_('NO')."</span></b>\n";
        $info .= "    </td>\n";
        $info .= "    <td align=\"center\">\n";
        $info .= "      <img src=\"images/$img\" border=\"0\" alt=\"\" />\n";
        $info .= "    </td>\n";
        ...
        $info .= "  <tr>\n";
        $info .= "    <td align=\"left\">\n";
        $info .= "      ".JText::_('JGA_MIGMAN_ORPHANPICS')."<b><span style=\"color:#f30; font-weight:bold;\">".$ctcount."</span></b>\n";
        $info .= "    </td>\n";
        $info .= "    <td align=\"center\">\n";
        $info .= "      &nbsp;";
        $info .= "    </td>\n";
    ...
    if (!$ready) {
      $this->Joom_Migrate_HTML(false,$info,
                              ...
                              '. JText::_('JGA_MIGMAN_FALSE').'</div><div style="text-align:center;">'.JText::_('JGA_MIGMAN_FALSE_LONG').'</div>');
    } else {
      $this->Joom_Migrate_HTML(true,$info,
                               '<div style="text-align:center;color:#080;padding:1em 0;font:bold 1.2em Verdana;">
                               '. JText::_('JGA_MIGMAN_TRUE').'</div><div style="text-align:center;">'.JText::_('JGA_MIGMAN_TRUE_LONG').'</div>');
    }
    return $ready;
  }
...
?>
  <tr>
    <td>
      <h4><?php echo JText::sprintf('JGA_MIGMAN_MIGRATIONCHECK', 'PonyGallery ML'); ?></h4>
    </td>
    <td align="center">
      <form action="index.php?option=<?php echo _JOOM_OPTION; ?>&amp;controller=migration" method="post">
        <div>
          <input type="hidden" name="migration" value="pony2joom" />
          <input type="hidden" name="task" value="check" />
          <input type="submit" value="<?php echo JText::_('JGA_MIGMAN_CHECK'); ?>" style="width:100px" />
        </div>
      </form>
    </td>
  </tr>
