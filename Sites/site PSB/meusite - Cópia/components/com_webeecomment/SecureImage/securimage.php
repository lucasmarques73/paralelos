...
class Securimage {
   ...
   *
   */
  function Securimage($JSession)
  {
  	$this->jSession = $JSession;
  	$this->gd_font_file = JPATH_COMPONENT.DS.'SecureImage'.DS.'gdfonts/bubblebath.gdf';
  	$this->ttf_file = JPATH_COMPONENT.DS.'SecureImage'.DS."elephant.ttf";
  ...
  function saveData()
  {
  	//JSession::set('securimage_code_value', strtolower($this->code));
  	$this->jSession->set('secureimage_code_value', strtolower($this->code));
  	//$jSession->set('securimage_code_value', strtolower($this->code));
  ...
  function validate()
  {
      if ( $this->jSession->get('securimage_code_value') == strtolower(trim($this->code_entered)))  {
        $this->correct_code = true;
        $this->jSession->set('securimage_code_value', '');
      } else {
