...
?>
      <td colspan="2" align="center">
        <applet name="JUpload" code="wjhk.jupload2.JUploadApplet" archive="<?php echo _JOOM_LIVE_SITE; ?>components/<?php echo _JOOM_OPTION; ?>/assets/java/wjhk.jupload.jar" width="700" height="600" mayscript>
          <param name="postURL" value="<?php echo _JOOM_LIVE_SITE; ?>index.php?option=<?php echo _JOOM_OPTION; ?>&task=upload&type=java">
