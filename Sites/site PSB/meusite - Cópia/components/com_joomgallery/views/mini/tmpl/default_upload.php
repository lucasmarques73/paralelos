<?php defined('_JEXEC') or die('Restricted access');
  ...
  <div class="jg-slider jg_uploadform">
    <form action="<?php echo JRoute::_('index.php?controller=upload&task=upload&tmpl=component&redirect='.base64_encode('index.php?view=mini&tmpl=component')); ?>" method="post" name="SingleUploadForm" enctype="multipart/form-data" onsubmit="return joom_singleuploadcheck()" >
...
<?php /*
      TODO: BUGTEST*/ ?>
      <input type="hidden" name="debug" value="<?php /*echo $bugtest;*/ ?>" /><?php /**/ ?>
    </form>
  </div>
