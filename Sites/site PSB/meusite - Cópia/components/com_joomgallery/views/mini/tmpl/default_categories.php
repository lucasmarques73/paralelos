  ...
  <div class="jg-slider">
    <div class="jg_bu_extended_options">
      <div class="jg_bu_option_key">
        <span title="<?php echo JText::_('JGS_MINI_CATEGORY_MODE'); ?>::<?php echo JText::_('JGS_MINI_CATEGORY_MODE_TIP'); ?>" class="hasTip"><?php echo JText::_('JGS_MINI_CATEGORY_MODE'); ?></span>
      </div>
      ...
      <div id="jg-category-thumbnails-options"<?php echo $this->params->get('default_category_mode', 0) == 1 ? ' class="jg_displaynone"' : ''; ?>>
        <div class="jg_bu_option_key">
          <span title="<?php echo JText::_('JGS_MINI_CATEGORY_LIMIT'); ?>::<?php echo JText::_('JGS_MINI_CATEGORY_LIMIT_TIP'); ?>" class="hasTip"><?php echo JText::_('JGS_MINI_CATEGORY_LIMIT'); ?></span>
        </div>
        <div class="jg_bu_option_value">
        ...
        <div class="jg_clearboth"></div>
        <div class="jg_bu_option_key">
          <span title="<?php echo JText::_('JGS_MINI_CATEGORY_COLUMNS'); ?>::<?php echo JText::_('JGS_MINI_CATEGORY_COLUMNS_TIP'); ?>" class="hasTip"><?php echo JText::_('JGS_MINI_CATEGORY_COLUMNS'); ?></span>
        </div>
        <div class="jg_bu_option_value">
        ...
        <div class="jg_clearboth"></div>
        <div class="jg_bu_option_key">
          <span title="<?php echo JText::_('JGS_MINI_CATEGORY_ORDERING'); ?>::<?php echo JText::_('JGS_MINI_CATEGORY_ORDERING_TIP'); ?>" class="hasTip"><?php echo JText::_('JGS_MINI_CATEGORY_ORDERING'); ?></span>
        </div>
        <div class="jg_bu_option_value">
      ...
      <div id="jg-category-linkedtext-options"<?php echo !$this->params->get('default_category_mode', 0) ? ' class="jg_displaynone"' : ''; ?>>
        <div class="jg_bu_option_key">
          <span title="<?php echo JText::_('JGS_MINI_CATEGORY_TEXTLINK'); ?>::<?php echo JText::_('JGS_MINI_CATEGORY_TEXTLINK_TIP'); ?>" class="hasTip"><?php echo JText::_('JGS_MINI_CATEGORY_TEXTLINK'); ?></span>
        </div>
        <div class="jg_bu_option_value">
      ...
      <hr />
      <div class="jg_bu_option_key">
        <span title="<?php echo JText::_('JGS_MINI_CATEGORY_SELECT'); ?>::<?php echo JText::_('JGS_MINI_CATEGORY_SELECT_TIP'); ?>" class="hasTip"><?php echo JText::_('JGS_MINI_CATEGORY_SELECT'); ?></span>
      </div>
      <div class="jg_bu_option_value">
