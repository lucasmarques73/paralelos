 ...
 * @version $Id: platform.php 123 2010-04-24 12:00:10Z nikosdion $
 */
...
class AEPlatform
{
	...
	public static function get_host()
	{
		if(defined('AKEEBACLI'))
		{
			return 'clibackup'; // It's lame, but it works
		}
	...
	private static function &getMailer()
	{
		...
		$sendmail 	= AEUtilJconfig::getValue('config.sendmail');
		$smtpauth 	= AEUtilJconfig::getValue('config.smtpauth');
		$smtpuser 	= AEUtilJconfig::getValue('config.smtpuser');
		$smtppass  	= AEUtilJconfig::getValue('config.smtppass');
		$smtphost 	= AEUtilJconfig::getValue('config.smtphost');
		$smtpsecure	= AEUtilJconfig::getValue('config.smtpsecure');
		$smtpport	= AEUtilJconfig::getValue('config.smtpport');
		$mailfrom 	= AEUtilJconfig::getValue('config.mailfrom');
		$fromname 	= AEUtilJconfig::getValue('config.fromname');
		$mailer 	= AEUtilJconfig::getValue('config.mailer');
