...
class ccNewsletterViewunsubscribe extends JView
{
	// in this case the view doesn't actually have to do anything
	// all we are doing is displaying the operationStatus which is set in the controller
